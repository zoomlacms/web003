<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_z52kwxq2" responseencoding="utf-8" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
...
.control-label {color:#fff;line-height:34px;min-width:80px;display:inline-block;}
    ...
    <div class="navbar navbar-fixed-top" role="navigation">
        ...
        <div class="user_mimenu_left">
            <ul class="list-unstyled">
                ...
                <li><a href="http://help.zoomla.cn" target="_blank">使用手册</a></li>
                <li><a href="http://www.zoomla.cn/mtv" target="_blank">视频教程</a></li>
                <li><a href="http://help.zoomla.cn/Database" target="_blank">数据字典</a></li>
                <li><a href="http://www.zoomla.cn/shop" target="_blank">商业授权</a></li>
                <li><a href="http://www.zoomla.cn/corp" target="_blank">关于逐浪</a></li>
                <li><a href="http://www.zoomla.cn/y10" target="_blank">十年辉煌</a></li>
            </ul>
        </div>
    ...
    <div class="container content_body text-left" style="max-width: 700px;">
        ...
        <div class="form-group">
            ...
            <span class="control-label text-center">
                <label><input type="checkbox" runat="server" id="ignoreSql_chk" /> 重置安装或已执行过脚本(推荐忽略)</label>
            </span>
...
<div class="container-fulid instcon">
    ...
    <div class="container text-left content_body" style="max-width: 740px; padding-left:160px;">
        ...
        <div class="form-group">
            ...
            <a class="name_tips" href="javascript:;" data-toggle="popover" data-content="如库中已有此管理员，会覆盖并重置现有同名最高管理员权限与密码；否则创建新管理员帐号。"><span class="glyphicon glyphicon-info-sign"></span></a> 
            <span class="control-label"></span>
        </div>
        <div class="form-group">
...
<div class="container-fulid instcon">
    ...
    <div class="container content_body">
        <div class="control-label insok">
              <h2><i class="fa fa-check-circle"></i> <a href="/Default.aspx"><%=Resources.L.已经成功安装点此进入首页 %></a><br/><span>定义Config/AppSettings.config中的Installed值为false执行重装</span></h2>
 </div>
        </div>
    </div>
</asp:WizardStep>
