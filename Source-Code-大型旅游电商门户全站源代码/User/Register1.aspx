<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register1.aspx.cs" Inherits="ZoomLa.WebSite.User.User_Register" ClientIDMode="Static" Debug="true" %><!DOCTYPE html>
...
<div id="backimg_div" style="background:url(/Template/Travel/style/images/userbg.jpg) center no-repeat; background-repeat:no-repeat; background-size:cover;">
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager> 
<div class="container" style="padding-top: 30px; ">
<div class="container" style="padding-top: 30px; ">
<div id="reg_main" style="margin-top:15%;">
...
<button type="button" runat="server" id="send_btn" name="send_btn" class="btn btn-info">
获取验证码
</button>
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ForeColor="Red" ErrorMessage="短信验证码不能为空" SetFocusOnError="false" ControlToValidate="MobileCode_T" />
...
<div class="row">
<div class="col-lg-6 col-md-6 col-sm-8 com-xs-12 col-md-offset-3 col-sm-offset-2">
<div class="myres_main">
<div class="row">
<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 myres_main_l">
<div class="myres_main_lt">
<ul>
<li class="active"><a href="#"><i class="fa fa-envelope"></i> 使用邮箱注册</a></li>
<li><a href="#"><i class="fa fa-mobile"></i> 使用手机注册</a></li>
<div class="clearfix"></div>
</ul>
</div>
<!--myres_main_lt end-->
<div class="myres_main_lc">
<ul>
<li>
<asp:TextBox ID="TxtUserName" CssClass="form-control" runat="server" onblur="CheckUser();" placeholder="请输入用户名" />
<div class="myres_main_lct">
...
<li>
<asp:TextBox ID="TxtPassword" TextMode="Password" runat="server" CssClass="form-control" onfocus=" focusinput();" onkeyup="f_checkrank();" placeholder="请输入您的密码" />
<div id="valPass" class="myres_main_lct" style="display:none;">
<span class="spantxt"><a id="idshow"></a></span><span class="spantxt"><a id="apass1" class="a_bor visible-xs"></a><a id="apass2" class="a_bor visible-xs"></a><a id="apass3" class="a_bor visible-xs"></a></span><span style="margin-left: 10px;">
...
<asp:CustomValidator runat="server" ID="CV1" ErrorMessage="密码强度过低" Display="Dynamic" ForeColor="Red" EnableClientScript="true" ClientValidationFunction="PwdCheck" ControlToValidate="TxtPassword" ValidationGroup="userVaid"></asp:CustomValidator>
</span>
</div>
</li>
<li>
<asp:TextBox ID="TxtPwdConfirm" TextMode="Password" runat="server" CssClass="form-control" placeholder="请再次输入您的密码，确认您的密码" />
<div class="myres_main_lct">
...
<asp:TextBox ID="TxtEmail" runat="server" CssClass="form-control" placeholder="请输入您的邮箱" />
<div class="myres_main_lct">
...
<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtEmail" Display="Dynamic" ForeColor="Red" ErrorMessage="邮件地址不规范" ValidationGroup="userVaid" ValidationExpression="^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$" />
</div>
</li>
<li>
...
<li>
<asp:Button ID="BtnSubmit" runat="server" Text="注册" CssClass="btn btn-default btn-block" ValidationGroup="userVaid" OnClick="BtnSubmit_Click"  />
<div class="myres_main_lct">
<p class="text-right login_remind">已有帐号，立即<a href="login.aspx">登录</a></p>
</div>
</li>
</ul>
</div>
...
<!--myres_main_l end-->
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 myures_main_r">
<ul>
<li><a href="/User" class="btn btn-danger btn-block"><i class="fa fa-weibo"></i> 新浪微博登录</a></li>
<li><a href="/User" class="btn btn-primary btn-block"><i class="fa fa-qq"></i> 腾讯账号登录</a></li>
<li><a href="/User" class="btn btn-success btn-block"><i class="fa fa-weixin"></i> 微信账号登录</a></li>
<li><a href="/User" class="btn btn-warning btn-block"><i class="fa fa-renren"></i> 人人账号登录</a></li>
</ul>
</div>
</div>
</div>
...
//if (i > 0) {
//i--;
//document.getElementById("send_btn").value = "(" + i + "秒后)重发验证码";
//document.getElementById("send_btn").disabled = "true";
//}
//else {
//    document.getElementById("send_btn").value = "重新获取验证码";
