...
<div class="myuser_youji_t">我的游记</div>
<ul class="media-list">
...
<div class="myuser_ask">
<div class="myuser_ask_t">我的问答</div>
<ul>
<%Call.Label("{ZL.Label id=\"输出当前用户问答列表\" TitleNum=\"60\" ShowNum=\"10\" /}");%>
</ul>
</div><!--myuser_ask end-->

<div class="myuser_ping">
<div class="myuser_ping_t">我的点评</div>
<ul>
<%Call.Label("{ZL.Label id=\"输出当前用户评论列表\" ShowNum=\"10\" /}");%>
</ul>
</div>
