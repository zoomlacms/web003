...
<style>
#Step1_Div{ font-size:12px;}
#Step1_Div a{color:#999;}
...
.denglu .form-control { font-size:14px; height:40px; border-radius:0; color:#979796;}
#Step1_Btn { background:#ffa800; border:1px solid #ffa800; border-radius:0; font-size:18px; width:100%;}
.other_type li { float:left; width:60px; text-align:center;}
.other_type li a { color:#989898; text-decoration:none;}
.other_type li a .fa-circle { color:#ffa800;}
.other_type li a:hover { color:#ff7000;}
...
<p><span>注册视为同意</span>《<a href="/Item/2189.aspx" target="_blank" title="TO行用户使用协议" style="color:#337ab7">TO行用户使用协议</a>》</p>
</div>
<div class="mid_line"></div>
</div>
<div class="other_type">
<p>已有账户？<a href="/User/Login.aspx" style="color:#337ab7">直接登陆</a>或使用第三方登陆</p>
<ul>
