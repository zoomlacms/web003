<%@ page language="C#" autoeventwireup="true" inherits="User_UserFunc_Deposit, App_Web_rjsl1evz" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="container margin_t10">
        <ol class="breadcrumb">
            ...
            <li class="active">用户充值
                ...
                [<a href="TradeFHList.aspx">手工分红记录</a>]
            </li>
        </ol>
    </div>
