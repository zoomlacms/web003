<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_SetSecondPWDWeb, App_Web_gta0r5xe" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_seta" runat="server">
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			<td style="width: 180px;">登录密码设置</td>
			<td style="width: 80px;">
				<asp:LinkButton runat="server"
