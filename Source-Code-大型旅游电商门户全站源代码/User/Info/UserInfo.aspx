<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserInfo, App_Web_ux5u4c3k" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="myuser_youji" style="padding:20px 10px;">
<div class="margin_t5"> 
<ol class="breadcrumb">
...
<tr><td colspan="2" class="text-center"><font color="red">本页需支付密码才能登录请输入支付密码</font></td></tr>
<tr>
<td><asp:TextBox runat="server" ID="Second" CssClass="form-control pull-right" TextMode="Password"></asp:TextBox></td>
<td style="width:50%;"><asp:Button runat="server" ID="sure" CssClass="btn btn-primary" Text="确定" OnClick="sure_Click" /></td>
</tr>
</table>
</div>  
...
<table class="table table-striped table-bordered table-hover">
<tr>
<td colspan="4"><ZL:UserBar ID="UserBar_U" Width="300" runat="server" /></td>
</tr>
<tr>
