<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.ExchangePeriod, App_Web_ux5u4c3k" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_seta" id="manageinfo" runat="server">
  <table class="table table-striped table-bordered table-hover">
	...
	<tr>
	  ...
	  <td style="width: 80%; line-height: 30px"><asp:RadioButton ID="RblBalance" runat="server" GroupName="ExchgType" Checked="true" Text="使用资金余额：" />
		将
	...
	<tr class="btn_green">
	  <td colspan="2" class="text-center"><asp:Button ID="EBtnSubmit" Text="兑换" CssClass="btn btn-primary" OnClick="EBtnSubmit_Click" runat="server" />
		<input id="Button1" type="button" class="btn btn-primary" value="返回" onclick="javascript: location.href = 'UserInfo.aspx'" /></td>
	</tr>
  </table>
</div>
</div>
