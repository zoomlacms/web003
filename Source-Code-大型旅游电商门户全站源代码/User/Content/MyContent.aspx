<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyContentpage, App_Web_cx3lrdec" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container margin_t5" style="width:800px;">
<ol class="breadcrumb" style=" padding-bottom:0px;">
<li><a title="会员中心" href="/User/Default.aspx">会员中心</a></li>
<li class="active">我的游记</li> 
</ol>
...
<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="width:800px;">
<div class="btn_green">
