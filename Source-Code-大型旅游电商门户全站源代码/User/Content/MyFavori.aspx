<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyFavori, App_Web_cx3lrdec" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container margin_t10" style=" width:780px; padding:0px;">
...
<div class="container u_cnt btn_green" style=" width:780px; padding:0px;"> 
