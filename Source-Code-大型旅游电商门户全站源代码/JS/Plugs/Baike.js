...
info.editTlp += '<td class="td_s"><a class="btn btn-danger" title="移除" onclick="info.delRow(this);"><i class="fa fa-remove"></i></a></td></tr>';
...
refence.showAdd = function () {
    comdiag.reload = true;
    ShowComDiag("/Guest/Baike/Diag/AddRef.aspx", "添加参考");
}
...
refence.showEdit = function (id) {
    comdiag.reload = true;
    ShowComDiag("/Guest/Baike/Diag/AddRef.aspx?id=" + id, "修改参考");
}
