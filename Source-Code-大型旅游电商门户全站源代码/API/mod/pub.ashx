 ...
 */ 
public class pub : System.Web.SessionState.IReadOnlySessionState, IHttpHandler
{
    B_User buser = new B_User();
    string Action { get { return Req("Action").ToLower(); } }
    string CallBack { get { return (HttpContext.Current.Request["callback"] ?? ""); } }
    ...
    private void ForDataColumn(DataTable dt)
    {
        M_UserInfo mu = buser.GetLogin();
        string[] fields = "PubAddTime,PubUserName,PubUserID,PubIP,Pubupid".Split(',');
