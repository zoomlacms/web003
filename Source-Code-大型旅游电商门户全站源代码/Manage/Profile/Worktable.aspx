<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa_WebSite_Manages_Worktable, App_Web_2af4rwv0" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="row padding_l_r10px">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding5">
        <div class="panel panel-default Worktable_well">
            <div class="panel-heading"><i class="fa fa-file"></i><span> 内容管理</span><span class="badge pull-right"><a href="javascript:;" title="内容管理" onclick="ShowMain('NodeTree.ascx','Content/ContentManage.aspx');">More</a></span></div>
            <div class="panel-body WorktableHeight"><div id="chart1" class="zlchart"></div></div>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding5">
        <div class="panel panel-default Worktable_well">
            <div class="panel-heading"><i class="fa  fa-shopping-cart"></i><span> 商城管理</span><span class="badge pull-right"><a href="javascript:;" title="商城管理" onclick="ShowMain('ShopNodeTree.ascx','Shop/ProductManage.aspx');">More</a></span></div>
            <div class="panel-body WorktableHeight"><div id="chart2" class="zlchart"></div></div>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding5">
        <div class="panel panel-default Worktable_well">
            <div class="panel-heading"><i class="fa  fa-user"></i><span> 会员管理</span><span class="badge pull-right"><a href="javascript:;" title="会员管理" onclick="ShowMain('UserGuide.ascx','User/UserManage.aspx');">More</a></span></div>
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 padding5">
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-book"></i><span><%=Resources.L.备忘录 %></span></div>
            <div class="panel-body WorktableHeight"><asp:TextBox ID="NoteBook" runat="server" CssClass="form-control" TextMode="MultiLine" Style="max-width: 100%; height: 100%; resize: none;" Columns="50" />
            </div>
            <div class="panel-footer"><span><%=Resources.L.提示 %>：<%=Resources.L.记录随Cookies删除而消失 %></span></div>
        </div>
    </div>
</div>
</div>
