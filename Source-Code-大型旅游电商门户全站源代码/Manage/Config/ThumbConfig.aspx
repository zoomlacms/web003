<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_ThumbConfig, App_Web_aqfobaxz" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
   ...
   <tr>
    ...
    <td><div><img id="iLogo_img" class="preview_img" style="width:110px;height:110px;" onerror="this.src='/Images/nopic.gif';"/><div class="file-panel" style="height: 0px;"><span class="editpic" title="编辑"></span><span class="cancel" title="删除"></span></div></div>
        <asp:TextBox runat="server" id="iLogo_url" type="text" class="form-control text_300"/></td>
    </tr>
    <tr>
    <td>编图水印：
    </td>
