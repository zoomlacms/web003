<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SiteInfo.aspx.cs" Inherits="Manage_I_Config_SiteInfo" MasterPageFile="~/Manage/I/Default.master" EnableViewStateMac="false" EnableViewState="False" ValidateRequest="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        <tr>
            ...
            <td><asp:TextBox ID="SiteName_T" runat="server"  class=" form-control text_300"/></td>
        </tr>
        <tr>
            <td class="tdbgleft"><strong><%:lang.LF("网站标题") %>：</strong></td>
            <td><asp:TextBox ID="SiteTitle_T" runat="server"  class="form-control text_300"/></td>
        </tr>
        <tr>
          <td class="tdbgleft"><strong><%:lang.LF("网站地址") %>：</strong></td>
          <td><asp:TextBox ID="SiteUrl_T" runat="server"  class="form-control text_300" />
        ...
        <tr>
            ...
            <td><asp:TextBox ID="LogoUrl_T" runat="server"  class="form-control text_300"/>
                <input type="button" value="上传图片" class="btn btn-info" onclick="pic.sel('LogoUrl_T');" />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="LogoAdmin_T" placeholder="初始值" runat="server"  class="form-control text_300"/>
                <input type="button" value="上传图片" class="btn btn-info" onclick="pic.sel('icon_text_LogoAdmin_T');" />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="LogoPlatName_T" runat="server" placeholder="初始值" class="form-control text_300"/>
                <input type="button" class="btn btn-default" value="推荐格式" onclick="setPlatName();" />
            </td>
        </tr>
        <tr>
            <td class="tdbgleft"><strong>官方二维码：</strong></td>
            <td><asp:TextBox ID="QRCode_T" runat="server"  class="form-control text_300"/></td>
        </tr>
        <tr>
          <td class="tdbgleft"><strong><%:lang.LF("公司名称") %>：</strong></td>
          <td>
          <asp:TextBox ID="ComName_T"  runat="server" CssClass="form-control text_300"/>
           </td>
          </tr>
        <tr>
            <td class="tdbgleft"><strong><%:lang.LF("站长姓名") %>：</strong></td>
            <td><asp:TextBox ID="Webmaster_T" runat="server" class="form-control text_300"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><asp:TextBox ID="MetaKeywords_T" runat="server" TextMode="MultiLine" class="form-control m715-50" style="height:60px;"/></td>
        </tr>
        <tr>
            <td class="tdbgleft"><strong><%:lang.LF("网站META网页描述") %>：</strong></td>
            <td><asp:TextBox ID="MetaDescription_T" runat="server" TextMode="MultiLine" class="form-control m715-50" style="height:60px;"/></td>
        </tr>
        <tr>
            <td class="tdbgleft"><strong><%:lang.LF("版权信息") %>：</strong></td>
            <td><asp:TextBox ID="Copyright_T" runat="server" TextMode="MultiLine"  class="form-control m715-50" style="height:100px;"/></td>
        </tr>
        <tr>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <style>        
        #icon_span_LogoAdmin_T {display:none;}
    </style>
    <script src="/JS/Controls/ZL_Dialog.js"></script>
    <script src="/JS/ICMS/ZL_Common.js"></script>
    <script src="/JS/Plugs/IconSelector.js"></script>
    ...
    <script>
        var pic = { id: "#pic_up", tid: "" };
        pic.sel = function (tid) {
            $(pic.id).val("");
            $(pic.id).click();
            pic.tid = tid;
        }
