<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddContent.aspx.cs" Inherits="V_Content_AddContent" MasterPageFile="~/Manage/I/Default.master" ClientIDMode="Static" ValidateRequest="false"  %>
...
<div class="manage_content">
    <div class="tabbable">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#Reward " data-toggle="tab"><%=Resources.L.悬赏定义 %></a></li>
        </ul>
        <div class="tab-content">
                ...
                <table id="mainTable" class="table table-bordered table_padding0 addcontent_modeltale">
                    <tr>
                        ...
                        <td class="col-sm-11 col-xs-11">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle" ErrorMessage="<%$Resources:L,标题不能为空 %>" ForeColor="Red" Display="Dynamic" />
                    ...
                    <tbody id="Sys_Fied" runat="server" style="display: none;">
                        <tr>
                            ...
                            <td><asp:TextBox ID="PYtitle" CssClass="form-control m715-50" runat="server" /></td>
                        </tr>
                        <tr id="spec_tr">
                        ...
                        <tr runat="server">
                            <td class="fd_td_l"><asp:Label ID="gjz_txt" runat="server" Text="<%$Resources:L,关键字 %>"></asp:Label></td>
                            <td>
                        ...
                        <tr runat="server">
                            <td class="fd_td_l"><asp:Label ID="Label4" runat="server" Text="<%$Resources:L,副标题 %>"></asp:Label></td>
                            <td><asp:TextBox ID="Subtitle" CssClass="form-control m715-50" runat="server"></asp:TextBox></td>
                        </tr>
                    </tbody>
                    ...
                    <tr id="CreateHTML" runat="server">
                        <td class="fd_td_l"><asp:Label ID="Label1" runat="server" Text="<%$Resources:L,生成 %>"></asp:Label></td>
                        <td><asp:CheckBox ID="quickmake" runat="server" Checked="false" Text="<%$Resources:L,是否立即生成 %>" /></td>
                    </tr>
                </table>
            ...
            <div class="tab-pane fade" id="InfoAttr">
                <table class="table table-bordered table_padding0">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtAddTime" CssClass="form-control text_md" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="fd_td_l"><asp:Label ID="gx_time" runat="server" Text="<%$Resources:L,更新时间 %>"></asp:Label></td>
                        <td><asp:TextBox ID="txtdate" CssClass="form-control text_md" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="fd_td_l"><span><%=Resources.L.自动审核 %></span></td>
                        <td><asp:TextBox ID="CheckDate_T" CssClass="form-control text_md" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="fd_td_l"><span><%=Resources.L.自动过期 %></span></td>
                        <td><asp:TextBox ID="TimeDate_T" CssClass="form-control text_md" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="fd_td_l"><asp:Label ID="hits_txt" runat="server" Text="<%$Resources:L,点击统计 %>"></asp:Label></td>
                        <td><asp:TextBox ID="txtNum" CssClass="form-control text_md" runat="server">0</asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><asp:CheckBox ID="Makepdf" runat="server" Text="<%$Resources:L,启用 %>" /></td>
                    </tr>
                </table>
            ...
            <div class="tab-pane fade" id="Process">
                <table class="table table-bordered">
                    <tr>
                        <td class="fd_td_l td_l"><asp:Label ID="tj_txt" runat="server" Text="<%$Resources:L,推荐级别 %>"></asp:Label></td>
                        <td><asp:CheckBox ID="ChkAudit" runat="server" /><%=Resources.L.推荐 %></td>
                    </tr>
                    <tr id="contentsk" runat="server">
                        <td class="fd_td_l"><asp:Label ID="zht_txt" runat="server" Text="<%$Resources:L,状态 %>"></asp:Label></td>
                        <td>
            ...
            <div class="tab-pane fade" id="Reward">
                <table class="table table-bordered table_padding0">
                    <tr>
                        <td class="fd_td_l td_l"><%=Resources.L.发布悬赏 %></td>
                        <td>
                            <asp:DropDownList ID="BidType" CssClass="form-control text_md" runat="server" onchange="changevalue(this.value);">
                                <asp:ListItem Value="0" Text="选择方式"></asp:ListItem>
                                <asp:ListItem Value="1" Text="单人中标"></asp:ListItem>
                                <asp:ListItem Value="2" Text="记件工资"></asp:ListItem>
                            </asp:DropDownList>
                            <div id="changeins" style="display: none">
                                <span><%=Resources.L.我想要 %></span><asp:TextBox ID="pronum" Width="30px" runat="server" CssClass="form-control text_xs">0</asp:TextBox><span> <%=Resources.L.个方案 %>，每个</span>
                                <asp:TextBox ID="bidmoney" Width="30px" runat="server" CssClass="form-control text_xs">0</asp:TextBox><span>元</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="fd_td_l"><%=Resources.L.项目完成周期 %> </td>
                        <td><asp:TextBox ID="proweek" CssClass="form-control text_xs" runat="server"></asp:TextBox><%=Resources.L.天 %></td>
                    </tr>
                </table>
            </div>
        </div>
