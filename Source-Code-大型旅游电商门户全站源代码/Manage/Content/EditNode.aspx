<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNode.aspx.cs" Inherits="Manage_I_Content_EditNode" MasterPageFile="~/Manage/I/Default.master"%>
...
<%--                            <input type="button" class="btn btn-primary" style="margin-left:5px;" value="修改" onclick="$('#TxtNodeDir').removeAttr('disabled');" />--%>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodePicUrl" class="form-control" style="width:400px;" runat="server"></asp:TextBox>
                            <input type="button" value="上传图片" class="btn btn-info" onclick="pic.sel();" />
