<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_24zd0abf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered">
                            ...
                            <table id="tgTable" class="classdiv">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtColoneDeposit" ErrorMessage="团购订金格式不对!" ValidationExpression="\d+[.]?\d*" Display="Dynamic" SetFocusOnError="True"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>最低团购人数：</td>
    ...
    <tbody id="Tabs3" style="border-top: none; display: none">
        <tr>
            <td class="td_l"><strong>市场价：<span class="rd_red">*</span></strong></td>
            <td>
        ...
        <tr>
            ...
            <td>
                <label><input type="radio" runat="server" value="0" groupname="UserPrice" name="UserPrice_Rad" id="UserPrice0_Rad" onclick="$('#userP').show(); $('#divGroup').hide();" checked />会员价</label>
                ...
                <div id="userP" runat="server" style="display: none;">
                    ...
                    <asp:RegularExpressionValidator ID="RV9" runat="server" ControlToValidate="userPrice" ErrorMessage="会员价格格式不正确!" ValidationExpression="\d+[.]?\d*" Display="Dynamic" ForeColor="Red" SetFocusOnError="True" />
                </div>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtPoint" ErrorMessage="PV值必须是数字!" ValidationExpression="^(-?\d+)(\.\d+)?$" SetFocusOnError="True" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Largesspirx" runat="server" Width="91px" class="form-control">0</asp:TextBox> 元 <span class="rd_green">设置为礼品且允许单独销售时的价格</span>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="Largesspirx" ErrorMessage="礼品价格必须是数字!" ValidationExpression="^(-?\d+)(\.\d+)?$" SetFocusOnError="True" />
            </td>
        </tr>
    </tbody>
