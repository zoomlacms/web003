<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_vdm1nh5v" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<ul class="menu2">
    ...
    <li class="menu2_5">
        <div class="btn-group topdrop">
            <button type="button" onclick="showleft('menu2_5','Content/CollectionManage.aspx')" class="btn btn-default  btn-sm "><%=Resources.L.采集检索 %></button>
            <button type="button" class="btn btn-default  btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                <span class="caret"></span><span class="sr-only"></span>
            </button>
            <ul class="dropdown-menu" role="menu">
                <li><a href="javascript:;" data-url="Content/CollectionStep1.aspx"><%=Resources.L.添加采集 %></a></li>
                <li><a href="javascript:;" data-url="Content/CollectionManage.aspx"><%=Resources.L.采集项目 %></a></li>
                <li><a href="javascript:;" data-url="Content/CollectionStart.aspx"><%=Resources.L.开始采集 %></a></li>
                <li><a href="javascript:;" data-url="Content/CollectionStatus.aspx"><%=Resources.L.采集进度 %></a></li>
                <li><a href="javascript:;" data-url="Content/CollectionList.aspx"><%=Resources.L.采集记录 %></a></li>
                <li><a href="javascript:;" data-url="Content/CollSite.aspx"><%=Resources.L.统一检索 %></a></li>
                <li><a href="javascript:;" data-url="Content/InfoLog.aspx"><%=Resources.L.检索动态 %></a></li>
            </ul>
        </div>  
    </li>
...
<ul class="menu5">
    ...
    <li class="menu5_8"><a onclick="showleft('menu5_8','Exam/News.aspx')"><%=Resources.L.数字出版 %></a></li>
</ul>
<ul class="menu6">
	...
	<li class="menu6_4"><a onclick="showleft('menu6_4','User/SendMailList.aspx')"><%=Resources.L.信息发送 %></a></li>
	<li class="menu6_5">      
          <div class="btn-group topdrop">
            <button type="button" onclick="showleft('menu6_5','User/SubscriptListManage.aspx?menu=audit')" class="btn btn-default  btn-sm "><%=Resources.L.订阅中心 %></button>
            <button type="button" class="btn btn-default  btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                <span class="caret"></span><span class="sr-only"></span>
            </button>
            <ul class="dropdown-menu" role="menu">
                <li><a href="javascript:;" data-url="User/SubscriptListManage.aspx?menu=all"><%=Resources.L.邮件订阅 %></a></li>
                <li><a href="javascript:;" data-url="User/RegValidateMail.aspx"><%=Resources.L.邮件模板 %></a></li>
                <li><a href="javascript:;" data-url="User/SendSubMail.aspx"><%=Resources.L.发送邮件 %></a></li>
                <li><a href="javascript:;" data-url="User/MailIdiographList.aspx"><%=Resources.L.签名管理 %></a></li>
            </ul>
        </div>
	</li>
...
<ul class="menu8">
	...
	<li class="menu8_4"><a onclick="showleft('menu8_4','Content/FlowManager.aspx')"><%=Resources.L.流程管理 %></a></li>
...
<ul class="menu9">
	...
	<li class="menu9_3"><a onclick="showleft('menu9_3','AddOn/Projects.aspx')"><%=Resources.L.项目管理 %></a></li>
	<li class="menu9_4"><a onclick="showleft('menu9_4','AddCRM/CustomerList.aspx?usertype=0')"><%=Resources.L.CRM管理 %></a></li>
	...
	<li class="menu9_6"><a onclick="showleft('menu9_6','User/ServiceSeat.aspx')"><%=Resources.L.客服通 %></a></li>
...
<ul class="menu10">
    ...
    <li class="menu10_5"><a onclick="showleft('menu10_5','WeiXin/EditWxMenu.aspx')"><%=Resources.L.菜单配置 %></a></li>
    <li class="menu10_6"><a onclick="showleft('menu10_1','/Tools/Mobile.aspx')"><%=Resources.L.移动浏览器 %></a></li>
</ul>
<ul class="menu11">
...
<div id="left_ul_div">
	...
	<div id="menu2" class="m_left_ul">
		...
		<ul class="list-unstyled m_left_ulin" id="menu2_5">
			...
			<li id="menu2_5_1"><a href="javascript:;" data-url="Content/CollectionManage.aspx"><%=Resources.L.采集项目 %></a></li>
			<li id="menu2_5_3"><a href="javascript:;" data-url="Content/CollectionStart.aspx"><%=Resources.L.开始采集 %></a></li>
			<li id="menu2_5_4"><a href="javascript:;" data-url="Content/CollectionStatus.aspx"><%=Resources.L.采集进度 %></a></li>
			<li id="menu2_5_5"><a href="javascript:;" data-url="Content/CollectionList.aspx"><%=Resources.L.采集记录 %></a></li>
            <li id="menu2_5_6"><a href="javascript:;" data-url="Content/CollSite.aspx"><%=Resources.L.统一检索 %></a></li>
            <li id="menu2_5_7"><a href="javascript:;" data-url="Content/InfoLog.aspx"><%=Resources.L.检索动态 %></a></li>
		</ul>
		...
		<ul class="list-unstyled m_left_ulin" id="menu2_9">
            ...
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i><%=Resources.L.论坛留言 %></p>
            <ul class="list-unstyled">
            ...
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i><%=Resources.L.问答管理 %></p>
            <ul class="list-unstyled">
			...
			<li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i><%=Resources.L.百科管理 %></p>
            <ul class="list-unstyled">           
	...
	<div id="menu3" class="m_left_ul">
		...
		<ul id="menu3_3" class="m_left_ulin">
			...
			<li id="menu3_3_3"><a href="javascript:;" data-url="Shop/OrderList.aspx?IsStore=true"><%=Resources.L.店铺订单 %></a></li>
            ...
            <li id="menu3_3_16"><a href="javascript:;" data-url="Shop/SystemOrderModel.aspx?Type=1"><%=Resources.L.订单模型 %></a></li>
		</ul>
		...
		<ul id="menu3_5" class="m_left_ulin">
			...
			<li id="menu3_5_5"><a href="javascript:;" data-url="Shop/UserExpenditure.aspx"><%=Resources.L.购物排名 %></a></li>
		</ul>
...
<%--			<li id="menu5_3_1"><a href="javascript:;" data-url="Exam/ClassManage.aspx"><%=Resources.L.班级管理 %></a></li>
		...
		<ul class="m_left_ulin" id="menu5_4">
			...
			<li id="menu5_4_2"><a href="javascript:;" data-url="AddCRM/CustomerList.aspx?usertype=0"><%=Resources.L.学员管理 %></a></li>
			<li id="menu5_4_3"><a href="javascript:;" data-url="iServer/BselectiServer.aspx?num=-3&strTitle="><%=Resources.L.学员管理 %></a></li>
			<li id="menu5_4_4"><a href="javascript:;" data-url="User/Message.aspx"><%=Resources.L.短信通知 %></a></li>
		</ul>
	...
	<div id="menu6" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu6_4">
			...
			<li id="menu6_4_4"><a href="javascript:;" data-url="User/SendMailList.aspx"><%=Resources.L.订阅列表 %></a></li>
			<li id="menu6_4_5"><a href="javascript:;" data-url="User/AddMail.aspx"><%=Resources.L.订阅群发 %></a></li>
			<li id="menu6_4_6"><a href="javascript:;" data-url="User/MailIdiographList.aspx"><%=Resources.L.签名管理 %></a></li>
			<li id="menu6_4_7"><a href="javascript:;" data-url="User/MailList.aspx"><%=Resources.L.邮件发送 %></a></li>
			<li id="menu6_4_8"><a href="javascript:;" data-url="User/MailTemplist.aspx"><%=Resources.L.群发模板 %></a></li>
			<li id="menu6_4_9"><a href="javascript:;" data-url="Mail/Mail.aspx"><%=Resources.L.邮件列表 %></a></li>
			<li id="menu6_4_10"><a href="javascript:;" data-url="Mail/MailMorSend.aspx"><%=Resources.L.邮件群发 %></a></li>
		</ul>
		<ul class="m_left_ulin" id="menu6_5">
			<li class="menu_tit"><span class="fa fa-chevron-down"></span><%=Resources.L.订阅中心 %></li>
			<li id="menu6_5_1"><a href="javascript:;" data-url="User/SubscriptListManage.aspx?menu=all"><%=Resources.L.邮件订阅 %></a></li>
			<li id="menu6_5_4"><a href="javascript:;" data-url="User/RegValidateMail.aspx"><%=Resources.L.邮件模板 %></a></li>
			<li id="menu6_5_5"><a href="javascript:;" data-url="User/SendSubMail.aspx"><%=Resources.L.发送邮件 %></a></li>
			<li id="menu6_5_8"><a href="javascript:;" data-url="User/MailIdiographList.aspx"><%=Resources.L.签名管理 %></a></li>
			<%--<li id="menu6_5_6"><a href="javascript:;" data-url="User/SendMailList.aspx"><%=Resources.L.邮件列表 %></a></li>
			<li id="menu6_5_7"><a href="javascript:;" data-url="User/SendMailList.aspx"><%=Resources.L.邮件发送 %></a></li>--%>
		</ul>
...
<%--			<li id="menu6_7_11"><a href="javascript:;" data-url="Zone/SnsSchool.aspx"><%=Resources.L.学校管理%></a></li>
	...
	<div id="menu7" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu7_7">
			<li class="menu_tit"><span class="fa fa-chevron-down"></span><%=Resources.L.站内链接%></li> 
        ...
        <ul class="m_left_ulin" id="menu7_9">
            ...
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i><%=Resources.L.微信应用%></p>
                <ul class="list-unstyled">
                    <li id="menu7_9_1"><a href="javascript:;" data-url="WeiXin/WxAppManage.aspx"><%=Resources.L.公众号码%></a></li>
                    <li id="menu7_9_2"><a href="javascript:;" data-url="WeiXin/SendWx.aspx"><%=Resources.L.消息群发%></a></li>
                    <li id="menu7_9_3"><a href="javascript:;" data-url="WeiXin/MsgsSend.aspx"><%=Resources.L.图文群发%></a></li>
                    <li id="menu7_9_9"><a href="javascript:;" data-url="WeiXin/WxMaterial.aspx?type=news"><%=Resources.L.素材中心%></a></li>
                    <li id="menu7_9_8"><a href="javascript:;" data-url="WeiXin/PayWeiXin.aspx"><%=Resources.L.微信支付%></a></li>
            </ul></li>
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i><%=Resources.L.微信支付%></p>
            <ul class="list-unstyled">
	...
	<div id="menu8" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu8_4">
			...
			<li id="menu8_4_1"><a href="javascript:;" data-url="Content/FlowManager.aspx"><%=Resources.L.流程管理%></a></li>
			<li id="menu8_4_2"><a href="javascript:;" data-url="Content/AuditingState.aspx"><%=Resources.L.状态编码%></a></li>
		</ul>
		...
		<ul class="m_left_ulin" id="menu8_8">
            ...
            <li id="menu8_8_6"><a href="javascript:;" data-url="WeiXin/PayWeiXin.aspx"><%=Resources.L.微信支付平台%></a></li>
		</ul>
	</div>
...
<%--		<li id="menu9_1_8"><a href="javascript:;" data-url="WorkFlow/AffairManage.aspx"><%=Resources.L.公文管理%></a></li>--%>
		...
		<ul class="m_left_ulin" id="menu9_3">
            ...
            <li id="menu9_3_4"><a href="javascript:;" data-url="AddOn/ProjectsType.aspx"><%=Resources.L.项目配置%></a></li>
            <li id="menu9_3_1"><a href="javascript:;" data-url="AddOn/ManageProjects.aspx"><%=Resources.L.项目管理%></a></li>
            <li id="menu9_3_2"><a href="javascript:;" data-url="AddOn/ProjectRequireList.aspx"><%=Resources.L.需求管理%></a></li>
            <li id="menu9_3_3"><a href="javascript:;" data-url="AddOn/WorkManage.aspx"><%=Resources.L.流程管理%></a></li>			
            <li id="menu9_3_5"><a href="javascript:;" data-url="AddOn/ProjectsModelField.aspx"><%=Resources.L.项目模型%></a></li>
		</ul>
		<ul class="m_left_ulin" id="menu9_4" style="height:700px;overflow:auto;">
			...
			<li id="menu9_4_1"><a href="javascript:;" data-url="AddCRM/CustomerList.aspx?usertype=0"><%=Resources.L.所有客户%></a></li>
			<li id="menu9_4_2"><a href="javascript:;" data-url="AddCRM/CustomerList.aspx?usertype=2"><%=Resources.L.企业客户%></a></li>
			<li id="menu9_4_3"><a href="javascript:;" data-url="AddCRM/CustomerList.aspx?usertype=1"><%=Resources.L.个人客户%></a></li>
		...
		<ul class="m_left_ulin" id="menu9_6">
			...
			<li><a href="javascript:;" data-url="User/ServiceSeat.aspx"><%=Resources.L.客服席位%></a></li>
            <li><a href="javascript:;" data-url="User/CodeList.aspx"><%=Resources.L.引用管理%></a></li>
			<li><a href="javascript:;" data-url="User/MsgEx.aspx"><%=Resources.L.聊天记录%></a></li>
...
<%--        <li id="menu9_8_6"><a href="javascript:;" data-url="Plus/TxtLog.aspx?LogType=4"><%=Resources.L.支付日志%></a></li>--%>
 <%--       <li id="menu9_8_6"><a href="javascript:;" data-url="Plus/AuditNotes.aspx"><%=Resources.L.审核记录%></a></li>--%>
    ...
    <div id="menu10" class="m_left_ul">
		<ul class="m_left_ulin open" id="menu10_1">
          ...
          <%--  <li id="menu10_1_2"><a href="javascript:;" data-url="/APP/Client/Default.aspx?u=Default.aspx&t=网站APP"><%=Resources.L.网站APP%></a></li>
            <li id="menu10_1_6"><a href="javascript:;" data-url="/APP/Client/Default.aspx?u=Default.aspx?APKMode=1&t=云打包APP"><%=Resources.L.云打包APP%></a></li>
            ...
            <li id="menu10_1_4"><a href="javascript:;" data-url="/APP/CL.aspx"><%=Resources.L.APP颁发%></a></li>
            <li id="menu10_1_5"><a href="javascript:;" data-url="/APP/AuthList.aspx"><%=Resources.L.授权审核%></a></li>
            <li id="menu10_1_7"><a href="javascript:;" data-url="/APP/Client/Default.aspx?u=Other/AuthAPPly.aspx&t=申请授权&s=1"><%=Resources.L.申请授权%></a></li>
            <li id="menu10_1_8"><a href="javascript:;" data-url="App/AppTlpOnline.aspx"><%=Resources.L.我的模板%></a></li>
            <li id="menu10_1_9"><a href="javascript:;" data-url="/APP/Client/Default.aspx?u=APPList.aspx&t=我的APP"><%=Resources.L.我的APP%></a></li>--%>
 ...
 <%--       <li id="menu10_1_3"><a href="http://wei.zoomla.cn/" target="_blank"><%=Resources.L.移动模拟器%></a></li>--%>
        ...
        <ul class="m_left_ulin" id="menu10_2"> 
		    <li class="bg-primary"><span class="fa fa-chevron-down"></span><%=Resources.L.微信应用%></li>		
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i><%=Resources.L.公众号码%></p>
            <ul class="list-unstyled">
            ...
            <li id="menu10_2_3"><a href="javascript:;" data-url="WeiXin/SendWx.aspx"><%=Resources.L.消息群发%></a></li>
            <li id="menu10_2_4"><a href="javascript:;" data-url="WeiXin/MsgsSend.aspx"><%=Resources.L.图文群发%></a></li>
            <li id="menu10_2_5"><a href="javascript:;" data-url="WeiXin/WxMaterial.aspx?type=news"><%=Resources.L.素材中心%></a></li>
            </ul></li> 		
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i><%=Resources.L.微信应用%></p>
            <ul class="list-unstyled">
            <li id="menu10_2_6"><a href="javascript:;" data-url="WeiXin/PayWeiXin.aspx"><%=Resources.L.微信支付%></a></li> 
        ...
        <ul class="m_left_ulin" id="menu10_5">
            <li class="menu_tit"><span class="fa fa-chevron-down"></span><%=Resources.L.菜单配置%></li> 
            <li id="menu10_5_1"><a href="javascript:;" data-url="WeiXin/WelPage.aspx?appid=0"><%=Resources.L.欢迎语%></a></li> 
            <li id="menu10_5_2"><a href="javascript:;" data-url="WeiXin/ReplyList.aspx?appid=0"><%=Resources.L.自动回复%></a></li>
            <li id="menu10_5_3"><a href="javascript:;" data-url="WeiXin/EditWxMenu.aspx?appid=0"><%=Resources.L.菜单配置%></a></li> 
            <li id="menu10_5_4"><a href="javascript:;" data-url="WeiXin/WxUserList.aspx?appid=0"><%=Resources.L.粉丝管理%></a></li> 
        </ul>
    </div>
...
<script>
    ...
    function PrePageInit() {
        ...
        pages += "Shop/ProductManage,Shop/AddProduct,Template/LabelManage.aspx,";
