<%@ page language="C#" autoeventwireup="true" inherits="User.AddUser, App_Web_5o4jssml" title="添加会员" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtpassword" runat="server" class="form-control text_md" TabIndex="3" onkeydown="return GetEnterCode('focus','tbEmail');" Style="max-width: 200px; float: left;" />
                    <span style="color: red;">*</span>
            ...
            <tr>
                ...
                <td class="style2" style="width: 35%;">
                    <asp:TextBox ID="tbEmail" runat="server" class="form-control text_md"  TabIndex="4" onkeydown="return GetEnterCode('focus','txtHoneyName');" Style="max-width: 200px; float: left;"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="width: 514px;">
                    <asp:TextBox ID="tbQuestion" runat="server" class="form-control text_md" TabIndex="6" onkeydown="return GetEnterCode('focus','tbAnswer');" Style="max-width: 200px; float: left;"></asp:TextBox>
                    <span style="color: red">*</span>
            ...
            <tr>
                ...
                <td style="width: 35%;">
                    <asp:TextBox ID="tbAnswer" runat="server"  TabIndex="7" onkeydown="return GetEnterCode('focus','DDLGroup');" class="form-control text_md" Style="max-width: 200px; float: left;"></asp:TextBox>
                    <span style="color: red; float: left;">*</span>
            ...
            <tr>
                ...
                <td style="width: 35%;">
                    <asp:TextBox ID="tbMobile" runat="server" class="form-control text_md" TabIndex="15" onkeydown="return GetEnterCode('focus','tbPHS');" ></asp:TextBox>
            ...
            <tr>
                ...
                <td style="width: 35%;">
                    <asp:TextBox ID="tbZipCode" runat="server" class="form-control text_md"  TabIndex="18" onkeydown="return GetEnterCode('focus','tbIDCard');" ></asp:TextBox></td>
            </tr>
            <tr>
