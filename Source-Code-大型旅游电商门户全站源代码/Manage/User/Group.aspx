<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.Group, App_Web_cvu4dt3w" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      ...
      <td><asp:TextBox class="form-control text_300" ID="TxtGroupName" runat="server" MaxLength="30" OnTextChanged="TxtGroupName_TextChanged" AutoPostBack="true" />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="TxtGroupName"><%=Resources.L.会员组名称不能为空 %></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox class="form-control int" Style="max-width: 150px; display:inline-block" ID="UpGradeMoney" runat="server">0</asp:TextBox><span><%=Resources.L.为0或空则不允许购买 %></span></td>
    </tr>
      <tr>
    ...
    <tr>
      ...
      <td><asp:TextBox class="form-control" style="max-width:150px;float:left;" ID="txtRebateRate" runat="server">0</asp:TextBox>
        <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="<%$Resources:L,请输入有效数据 %>" Operator="GreaterThanEqual" Type="Double" ValueToCompare="0"  ControlToValidate="txtRebateRate"></asp:CompareValidator></td>
    </tr>
    <tr>
