<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_cvu4dt3w" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="text-left">
                                        <asp:TextBox ID="txtHoneyName" runat="server" onkeydown="return GetEnterCode('focus','WorkNum_T');" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <asp:TextBox ID="txtSilverCoin" runat="server" onkeydown="return GetEnterCode('focus','txtCerificateDeadLine');" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                                    </td>
                                    <td class="text-right">用户积分： </td>
                                    <td class="text-left">
                                        <asp:TextBox ID="txtPoint" runat="server" onkeydown="return GetEnterCode('focus','txtPurm');" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right">点券： </td>
                                    <td class="text-left">
                                        <asp:TextBox ID="txtUserPoint"  onkeydown="return GetEnterCode('focus','txtPoint');" runat="server" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                                    </td>
                                    <td class="text-right">虚拟币： </td>
                                    <td class="text-left">
                                        <asp:TextBox ID="txtPurm" runat="server" onkeydown="return GetEnterCode('focus','txtSilverCoin');" class="form-control" Style="max-width: 200px;"></asp:TextBox>
                                    </td>
                                </tr>
