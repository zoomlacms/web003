<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_UserManage, App_Web_cvu4dt3w" title="会员管理" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
    <li><a href='<%=CustomerPageAction.customPath2 %>Main.aspx'><%=Resources.L.工作台 %></a></li><li><a href='AdminManage.aspx'><%=Resources.L.用户管理 %></a></li><li><a href='UserManage.aspx'><%=Resources.L.会员管理 %></a><a href='AddUser.aspx' class='reds'>[<%=Resources.L.添加会员 %>]</a></li>
...
<table id="EGV" class="table table-striped table-bordered table-hover" >
  <tr>
	...
	<td><asp:LinkButton runat="server" ID="Purse_A" CommandArgument="Purse" OnClick="OrderBtn_Click"><%=Resources.L.资金 %><i class='glyphicon glyphicon-arrow-up order_img'></i></asp:LinkButton></td>
	<td><asp:LinkButton runat="server" ID="Addtime_A" CommandArgument="Addtime" OnClick="OrderBtn_Click"><%=Resources.L.注册时间 %><i class='glyphicon glyphicon-arrow-up order_img'></i></asp:LinkButton></td>
	<td><asp:LinkButton runat="server" ID="point_A" CommandArgument="point" OnClick="OrderBtn_Click"><%=Resources.L.积分 %><i class='glyphicon glyphicon-arrow-up order_img'></i></asp:LinkButton></td>
	<td><asp:LinkButton runat="server" ID="LoginTimes_A" CommandArgument="LoginTimes" OnClick="OrderBtn_Click"><%=Resources.L.登录次数 %><i class='glyphicon glyphicon-arrow-up order_img'></i></asp:LinkButton></td>
	<td><asp:LinkButton runat="server" ID="AuthTime_A" CommandArgument="AscAuthTime" OnClick="OrderBtn_Click"><%=Resources.L.最后登录时间 %><i class='glyphicon glyphicon-arrow-up order_img'></i></asp:LinkButton></td>
