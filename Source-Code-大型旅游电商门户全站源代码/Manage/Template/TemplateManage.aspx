<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_TemplateManage, App_Web_m22flkqc" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table width="100%" class="table table-bordered">
        <tr>
            <td align="left"><%=Resources.L.当前目录 %>：<asp:Label ID="lblDir" runat="server" Text="Label"></asp:Label></td>
            <td align="right">
