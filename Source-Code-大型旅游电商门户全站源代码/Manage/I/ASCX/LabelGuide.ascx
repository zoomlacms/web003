<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_LabelGuide, App_Web_ai2itopa" %>
...
<div class="tvNavDiv" style="height:auto;">
    <div class="left_ul">
        <ul>
            <li class=""><a href="javascript:;" onclick="ShowMain('','{$path}Template/TemplateSet.aspx');"><%=Resources.L.方案设置 %></a></li>
