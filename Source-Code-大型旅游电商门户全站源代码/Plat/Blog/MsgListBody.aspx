<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_MsgListBody, App_Web_gpjmatla" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<start>
	...
	<ItemTemplate>
	  <div class="msgitem" id="msgitem-<%#Eval("ID") %>">
		...
		<div class="msg_content_div plat_content_div">
		    <div class="content_head"><a href="/Plat/Blog/?uids=<%#Eval("CUser") %>" title="<%#Eval("CUName") %>的工作流"><%#Eval("CUName") %></a> <%#GetColled() %></div>
