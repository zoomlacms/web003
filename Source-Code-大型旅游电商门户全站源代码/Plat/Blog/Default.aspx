<%@ page language="C#" autoeventwireup="true" enablesessionstate="True" inherits="Plat_Task_Default, App_Web_gpjmatla" masterpagefile="~/Plat/Main.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div runat="server" id="pcmsgdiv">
  <div>
      <ul id="child_nav_ul">
          ...
          <li><a href="javascript:B_Msg.showLong();">长文章</a></li>
      </ul>
      <div class="clearfix"></div>
  </div>
...
<div class="ed_main" id="long_div" style="display:none;">
    <div class="ed_header">
        <div class="ed_header_wrap">
            <h1>长文章</h1>
            <a href="javascript:;" class="btn btn-default back" id="back_btn" onclick="B_Msg.closeLong();"><i class="fa fa-chevron-left"></i>返回</a>
            <a href="javascript:;" class="btn btn-default save" id="save_btn" onclick="B_Msg.addLong();">发布文章</a>
        </div>
    </div>
    <div class="ed_content"><textarea id="long_t" style="width: 100%; height: 600px;"></textarea></div>
</div>
...
.ed_main {background-color:#fbfcf7;overflow-y:auto;color:#222;position:fixed;z-index:10;width:100%;top:0px;left:0px;}
.ed_header {width:100%;border-bottom:1px solid #e3e3e3;opacity:0.5;}
.ed_header_wrap {width:600px;margin:0 auto;position:relative;}
.ed_header_wrap h1 {font-size:18px;font-weight:600;padding:10px 0px 15px 15px;}
.ed_header .back {position:absolute;top:5px;left:-75px;}
.ed_header .save {position:absolute;top:5px;right:-75px;}
.ed_content {width:600px;margin:0 auto;position:relative;margin-top:5px;}
</style>
